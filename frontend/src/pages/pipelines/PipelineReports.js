  ...
  <div>
    ...
    <div style={{ ...card, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16 }}>
      {Object.entries(REPORT_META).map(([k, v]) => (
        <div key={k}>
          <div style={{ fontSize: 9, fontWeight: 700, color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: 'var(--font-mono)', marginBottom: 4 }}>
            {k.replace(/_/g, ' ')}
          </div>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
      ...
      <div style={card}>
        ...
        <table style={{ borderCollapse: 'collapse', width: '100%' }}>
          <thead>
            <tr>
              <th style={{ padding: '8px 12px', background: '#F9FAFB', border: '1px solid #E5E7EB', fontSize: 10, color: '#6B7280', fontWeight: 700, fontFamily: 'var(--font-mono)' }}>
                Predicted ↓ · Actual →
              </th>
          ...
          <tbody>
            <tr>
              ...
              <td style={{ padding: '14px 12px', border: '1px solid #E5E7EB', textAlign: 'center', background: '#F0FDF4' }}>
                ...
                <div style={{ fontSize: 10, color: '#6B7280', fontFamily: 'var(--font-mono)' }}>TN</div>
              </td>
              <td style={{ padding: '14px 12px', border: '1px solid #E5E7EB', textAlign: 'center', background: '#FEF2F2' }}>
                ...
                <div style={{ fontSize: 10, color: '#6B7280', fontFamily: 'var(--font-mono)' }}>FP</div>
              </td>
            </tr>
            <tr>
              ...
              <td style={{ padding: '14px 12px', border: '1px solid #E5E7EB', textAlign: 'center', background: '#FEF2F2' }}>
                ...
                <div style={{ fontSize: 10, color: '#6B7280', fontFamily: 'var(--font-mono)' }}>FN</div>
              </td>
              <td style={{ padding: '14px 12px', border: '1px solid #E5E7EB', textAlign: 'center', background: '#F0FDF4' }}>
                <div style={{ fontSize: 18, fontWeight: 800, color: '#10B981' }}>{CM[1][1].toLocaleString()}</div>
                <div style={{ fontSize: 10, color: '#6B7280', fontFamily: 'var(--font-mono)' }}>TP</div>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div style={card}>
        ...
        <svg viewBox={`0 0 ${W + 40} ${H + 30}`} style={{ width: '100%', maxWidth: 260 }}>
          ...
          />
          {/* Axis labels */}
          <text x={30 + W / 2} y={H + 22} fontSize={9} fill="#9CA3AF" textAnchor="middle" fontFamily="var(--font-mono)">
            False Positive Rate
          </text>
          <text x={12} y={H / 2} fontSize={9} fill="#9CA3AF" textAnchor="middle" fontFamily="var(--font-mono)"
