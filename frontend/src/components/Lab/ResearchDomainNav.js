            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
              ...
              >
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-gray-500 outline-none focus:border-[#00E0FF]/50"
                  aria-label="Search experiments / runs"
                />
              </form>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="px-3 py-2 rounded-lg border border-white/10 bg-white/5 text-sm text-gray-200">
                  Samuel Guxegdsa
                </div>
              </div>
            </div>
