...
const PROVIDERS = [
  { key: 'github',   label: 'GitHub',   bg: '#111827', border: '#374151', color: '#F9FAFB' },
  { key: 'gitlab',   label: 'GitLab',   bg: '#111827', border: '#374151', color: '#F9FAFB' },
  { key: 'linkedin', label: 'LinkedIn', bg: '#111827', border: '#374151', color: '#F9FAFB' },
  { key: 'google',   label: 'Google',   bg: '#111827', border: '#374151', color: '#F9FAFB' },
];
        ...
        {PROVIDERS.map((p) => (
          <button
            ...
            style={{
              ...
              opacity:        loading && loading !== p.key ? 0.5 : 1,
              transition:     'opacity 0.15s, border-color 0.15s',
              whiteSpace:     'nowrap',
            }}
            onMouseEnter={(e) => {
              if (!loading) e.currentTarget.style.borderColor = '#6B7280';
            }}
            onMouseLeave={(e) => {
